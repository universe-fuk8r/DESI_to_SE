# DESI DR1 cosmic web for SpaceEngine — LITE tier

This addon imports 250,000 real galaxies and quasars from the
...
> Built: 2026-05-02 — converter v1.0.0 — tier: lite

## What's in this tier

~250k local-universe BGS galaxies, no QSOs. Runs on anything.
...
```
SpaceEngine/addons/DESI_DR1_lite/
```
