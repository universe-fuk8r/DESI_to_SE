# DESI DR1 cosmic web for SpaceEngine — HEAVY tier

This addon imports 6,400,000 real galaxies and quasars from the
...
> Built: 2026-05-02 — converter v1.0.0 — tier: heavy

## What's in this tier

~6M galaxies + ~400k QSOs to z~3.

| Object class | Count |
|---|---:|
| Galaxies | 6,000,000 |
| Quasar hosts | 400,000 |
| **Total** | **6,400,000** |
...
Copy this whole `DESI_DR1_heavy` folder into a SpaceEngine `addons`
...
- **Don't nest the folder.** If your unzip tool produced
  `DESI_DR1_heavy\DESI_DR1_heavy\`, move the inner one up a
  level.
